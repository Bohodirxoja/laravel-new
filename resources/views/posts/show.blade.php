        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="display-4 mb-4 mb-md-0 text-secondary text-uppercase">Post-{{$post->id}}</h1>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn btn-sm btn-outline-dark mr-2" href="{{route('posts.edit',['post'=>$post->id])}}">add Post</a>
                        <form action="{{route('posts.destroy',['post'=>$post->id])}}" method="post" onsubmit="return confirm('Rostan ojirasami');">
                            @csrf
                            @method('DELETE')
...
{{--                            </div>--}}
                        ...
                        @else
                            <div class="">
                                Comment Create?
                                <a href="{{route('login')}}" class="btn btn-success">access</a>
                            </div>
                        @endauth
                    </div>
                </div>
